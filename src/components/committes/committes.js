import { Avatar, Card, CardActionArea, CardContent, Container, Grid, Hidden, Typography } from "@material-ui/core";
...
function Committes() {
  const cheifPatron = [
    ...
    createData(2, "Sri P. Balaji", "CEO, Vasavi College of Engineering"),
  ];
  ...
  const gC = [
    createData(1, "Dr. T. Adilakshmi", "Professor & HOD, CSE, VCE"),
    createData(2, "Dr. Suresh Chandra Satapathy", "KIIT DU, Bhubaneswar"),
  ];
  const pC = [
    createData(1, "Dr. Nagaratna P. Hegde", "Professor, CSE, VCE"),
    createData(
      2,
      "Dr. Vikrant Bhateja",
  ...
  const oC = [createData(1, "Dr. T. Adilakshmi", "Professor & HOD, CSE, VCE")];
  const progC = [
      ...
      >
        <Grid container>
          <Grid item lg={12} sm={12} md={12}>
            <Typography variant="h4" align="left" component="h6">
              Chief Patrons
            </Typography>
          </Grid>
          <Grid item lg={12} sm={12} md={12}>
